...
The LED was able to be toggled based on user inputs on the webpage. The webpage also displayed accurate temperature readings with different resolutions based on user inputs.
...
![Figure 3](images/ai_proto_1.png)(Figure 3: Webpage created by ChatGPT)
